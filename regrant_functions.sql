-- Regrant all custom functions after Postgres upgrade
-- Generated: $(date)
-- Run this AFTER the Postgres upgrade to restore function access

BEGIN;

-- anon role: 28 functions (Public REST endpoints)
GRANT EXECUTE ON FUNCTION public.club_chat_heartbeat() TO anon;
GRANT EXECUTE ON FUNCTION public.club_chat_horn() TO anon;
...
-- authenticated role: 64 functions
...
-- service_role: 92 functions (internal/admin)
